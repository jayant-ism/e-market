    ...
    <div className="row" style={{justifyContent: "center"}}>
        <div className="card col-md-3 col-12">
            <div className="card-content">
                <div className="card-body"> <img className="image" src="https://i.imgur.com/S7FJza5.png" alt="" />
        ...
        <div className="card col-md-3 col-12 ml-2">
            <div className="card-content">
                <div className="card-body"> <img className="image" src="https://i.imgur.com/xUWJuHB.png" alt="" />
                <div className="shadow"></div>
        ...
        <div className="card col-md-3 col-12 ml-2">
            <div className="card-content">
                <div className="card-body"> <img className="image rck" src="https://i.imgur.com/rG3CGn3.png" alt="" />
