    ...
    <div className="container">
       <div className="row">
         <div className="col-sm-9 col-md-7 col-lg-5 mx-auto dashboard">
           <a href="/shop" className="btn btn-lg btn-primary btn-block text-uppercase shadow">Shoping</a>
           <a href="/cart" className="btn btn-lg btn-primary btn-block text-uppercase shadow">Cart</a>
